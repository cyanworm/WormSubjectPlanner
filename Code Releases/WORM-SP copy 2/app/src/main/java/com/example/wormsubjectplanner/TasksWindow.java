     ...
     public void openAdd() {
          ...
          popupbd.setPositiveButton("Save", new DialogInterface.OnClickListener() {
               public void onClick(DialogInterface dialog, int data) {
                    ...
                    if (temp.isEmpty()) Toast.makeText(context,"Invalid task! Must not be empty!", Toast.LENGTH_SHORT).show();
                    else{
     ...
     public void openEdit() {
          ...
          popupbd.setPositiveButton("Save", new DialogInterface.OnClickListener() {
               public void onClick(DialogInterface dialog, int data) {
                    ...
                    Context context = getApplicationContext();
                    if (newtask.isEmpty()) Toast.makeText(context, "Invalid task! Must not be empty!",  Toast.LENGTH_SHORT).show();
                    else taskDAO.editTask(buttonName,newtask);
                    viewTasks();
               }
          });
